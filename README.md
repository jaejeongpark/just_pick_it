...
상품을 인식해 그리퍼 방향까지 맞춰 파지하는 흐름입니다. **(1) 대상 인식 + 파지 방향 -> (2) 접근 -> (3) 미세 정렬·파지**의 세 phase로 진행하며, 아래에서 각 phase를 데모와 함께 설명합니다.

##### Phase 1. 대상 인식 & 파지 방향 — YOLO-segmentation

<p align="center">
  <img src="docs/img/cobot_img/yolo_seg.gif" width="90%" alt="YOLO-segmentation 기반 대상 인식 및 OBB 파지 방향" /><br/>
  <em>YOLO-segmentation으로 6종 상품 학습·실시간 인스턴스 분할 검출, OBB 각도로 파지 방향(J6) 산출</em>
</p>
...
##### Phase 2. 접근 — Analytic IBVS

<p align="center">
  <img src="docs/img/cobot_img/pick_analytic_ibvs.gif" width="90%" alt="Analytic IBVS 접근" /><br/>
  <em>Analytic IBVS: Align · Approach 반복 제어로 대상에 접근</em>
</p>
...
##### Phase 3. 미세 정렬 & 파지 — NN (closed-loop -> open-loop)

<p align="center">
  <img src="docs/img/cobot_img/pick_nn_ibvs.gif" width="90%" alt="NN closed-loop/open-loop 미세 정렬 및 파지" /><br/>
  <em>NN closed-loop/open-loop 미세 정렬과 GripSuccessPredictor 기반 파지</em>
</p>
