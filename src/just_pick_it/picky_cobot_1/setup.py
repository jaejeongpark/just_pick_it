...
setup(
    ...
    zip_safe=True,
    maintainer='Juminsun',
    maintainer_email='mnbv9487@gmail.com',
    description='Cobot State Manager for just_pick_it system',
    license='Apache-2.0',
    extras_require={
        'test': [
            'pytest',
    ...
    entry_points={
        'console_scripts': [
            ...
            'place_scan_seeder = picky_cobot_1.place_scan_seeder:main',
