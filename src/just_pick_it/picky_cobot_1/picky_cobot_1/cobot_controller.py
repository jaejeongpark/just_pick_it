...
LOAD_SLOT_ANGLES = [
    {  # slot 0 (item 1)
        'approach': [4.39, -30.94, -39.25, -14.24, 2.98, -131.03],
        'place':    [4.39, -30.94, -52.00, -7.67, 2.98, -131.03],
    },
    {  # slot 1 (item 2)
        'approach': [5.44, -10.01, -68.25, -9.32, 2.90, -134.47],
        'place':    [5.44, -10.01, -82.13, -0.70, 2.81, -134.47],
    },
    {  # slot 2 (item 3)
        'approach': [25.83, -39.76, -21.22, -28.86, -1.65, -108.98],
        'place':    [25.83, -39.76, -31.29, -19.21, -1.65, -108.98],
    },
    {  # slot 3 (item 4)
