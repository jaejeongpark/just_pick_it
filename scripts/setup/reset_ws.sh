...
#
# 옵션:
#   RESET_DB=0 bash scripts/setup/reset_ws.sh       # DB schema/seed 유지
#   RESET_VENV=0 bash scripts/setup/reset_ws.sh     # web/.venv 유지
...
log "done"
log "run: bash scripts/runtime/run_all.sh"
