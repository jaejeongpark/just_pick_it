...
def render_admin_page(request: Request, page: str):
    return render_template(
        request,
        "admin.html",
        {
            "page": page,
            **ADMIN_PAGE_CONTEXTS[page],
        },
    )
